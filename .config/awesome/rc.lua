...
globalkeys = gears.table.join(
    ...
    -- Keybind applications dewek
    awful.key({ modkey, alt }, "m", function () awful.spawn("st cmus") end,
              {description = "music gan", group = "gaww"}),

    awful.key({ modkey      }, "n", function () awful.spawn(filemanager) end,
              {description = "thunar the best", group = "gaww"}),

    awful.key({ modkey, alt }, "b", function () awful.spawn(browser) end,
              {description = "chromium madep", group = "gaww"}),

    awful.key({ modkey, alt, "Shift" }, "d", function () awful.spawn(xfce4-appfinder) end,
              {description = "appfinder salain dmenu", group = "gaww"}),

    -- Menubar
    awful.key({ modkey, "Shift" }, "d", function () awful.spawn("dmenu_run -sb orange -sf black -l 2") end,
              {description = "dmenu gan", group = "launcher"}),
...
awful.spawn.with_shell("/home/gawwsu/.config/polybar/run.sh")
